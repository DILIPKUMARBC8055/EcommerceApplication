...
WORKDIR /src
COPY ["ApiGateway/Ocelot.ApiGateway/Ocelot.ApiGateway.csproj", "ApiGateway/Ocelot.ApiGateway/"]
RUN dotnet restore "./ApiGateway/Ocelot.ApiGateway/Ocelot.ApiGateway.csproj"
COPY . .
WORKDIR "/src/ApiGateway/Ocelot.ApiGateway"
